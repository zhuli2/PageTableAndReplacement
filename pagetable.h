...
#define PG_VALID        (0x1) // = 0001: Valid bit in pgd or pte, set (to 1) if in memory
#define PG_DIRTY        (0x2) // = 0010: Dirty bit in pgd or pte, set (to 1) if modified
#define PG_REF          (0x4) // = 0100: Reference bit, set (to 1) if page has been referenced
#define PG_ONSWAP       (0x8) // = 1000: Set (to 1) if page has been evicted to swap
